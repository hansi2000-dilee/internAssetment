        ...
        <div class="col-12 mt-5">
            <form role="form" action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="studentid" name="stu_id" aria-describedby="emailHelp">
                ...
                <button type="submit" class="col-lg-5 offset-lg-4  mt-3 text-dark mb-4">Submit</button>
              </form>
        </div>
    </div>
</div>
