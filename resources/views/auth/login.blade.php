...
<div class="col-12">
    <div class="row">
        <div class="col-5 offset-4 p-3" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td class="p-2"><x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
            </td>
        </tr>
        <tr>
            <td class="p-2"> <x-label for="password" value="{{ __('Password') }}" /></td>
            <td class="p-2">  <x-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" />
            </td>
        </tr>
        <tr>
            <td class="p-2"> <label for="remember_me" class="flex items-center">
